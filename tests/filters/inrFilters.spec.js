...
describe('Playground', () => {
  it('trim leading zeros', () => {
    expect('0001'.trimLeft('0')).toBe('1')
  })

  it('string are arrays', () => {
    expect('12345'[0]).toBe('1')
  })

  it('diviend of two digit by 10 is always first digit', () => {
    let num = 85
    expect((num - (num % 10))/10).toBe(8)
    expect(num).toBe(85)
  })
})
